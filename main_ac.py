...
def generate_spectrum(output_name,input_audio, channel,fps, res_width, res_height, t_smoothing, xlow, xhigh, limt_junk, attenuation_steep, junk_threshold, threshold_steep, style, thickness, compression, callback_function):
    ...
    os.remove(resource_path("resources/temporary_file.mp4"))
...
def resource_path(relative_path):
    if hasattr(sys, '_MEIPASS'):
        base_path = sys._MEIPASS   # carpeta temporal cuando usas --onefile
    else:
        base_path = os.path.dirname(os.path.abspath(__file__))  # carpeta del script/exe
...
gif1 = load_gif(resource_path("resources/resized_img_spec.gif"))
gif2 = load_gif(resource_path("resources/resized_img_swav.gif"))
gif3 = load_gif(resource_path("resources/resized_img_lwav.gif"))
gif4 = load_gif(resource_path("resources/resized_img_osc.gif"))
gif5 = load_gif(resource_path("resources/resized_img_specdB.gif"))
gif6 = load_gif(resource_path("resources/resized_img_polar.gif"))
gif7 = load_gif(resource_path("resources/resized_img_polar_stereo.gif"))
gif8 = load_gif(resource_path("resources/resized_img_spec_balance.gif"))
gif9 = load_gif(resource_path("resources/resized_img_recurrence.gif"))
gif10 = load_gif(resource_path("resources/resized_img_poincare.gif"))
gif11 = load_gif(resource_path("resources/resized_img_embed2.gif"))
gif12 = load_gif(resource_path("resources/resized_img_histogram.gif"))
gif13 = load_gif(resource_path("resources/resized_img_histogram.gif"))
logo = tk.PhotoImage(file=resource_path("resources/lsao logotype.png"))
