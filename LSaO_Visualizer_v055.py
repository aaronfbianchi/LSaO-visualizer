...
class OscilloscopeWindow:
    ...
    def __init__(self, master):
        self.master = master
        self.master.title("Oscilloscope Visualizer v0.02 by Aaron F. Bianchi")
...
def option1():
    # Display the existing window when Option 1 is pressed
...
# Main window
root = tk.Tk()
root.title("LSaO Visualizer v0.55")
...
button_option2.grid(row=row_num, column=1, padx=0, pady=0, sticky="w")

# Button for option 3
button_option3 = tk.Button(root, image=image3, text="Long Waveform", compound=tk.BOTTOM, command=option3, width=130, height=130)
button_option3.grid(row=row_num, column=2, padx=0, pady=0, sticky="w")

# Button for option 4
button_option4 = tk.Button(root, image=image4, text="Oscilloscope", compound=tk.BOTTOM, command=option4, width=130, height=130)
button_option4.grid(row=row_num, column=3, padx=0, pady=0, sticky="w")

row_num += 1
# Credits label
credits_label = tk.Label(root, text="© 2024 Aaron F. Bianchi - Linear Spectrum and Oscilloscope Visualizer", font=("Helvetica", 10), fg="blue", justify='center')
credits_label.grid(row=row_num, column=0, columnspan=4, pady=5, sticky="ew") 
